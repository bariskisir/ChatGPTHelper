...
namespace Renderer {
  ...
  export function renderState(refs: DomRefs.Refs, model: UiModel, state: AppViewState): void {
  ...
  export function renderStreamingAnswer(refs: DomRefs.Refs, model: UiModel, answer: string): void {
  ...
  export function renderManualImage(refs: DomRefs.Refs, dataUrl: string): void {
  ...
  export function setManualDraftMode(refs: DomRefs.Refs, model: UiModel, enabled: boolean): void {
  ...
  export function setCompactMode(refs: DomRefs.Refs, model: UiModel, enabled: boolean): void {
  ...
  function renderAccount(refs: DomRefs.Refs, state: AppViewState): void {
  ...
  function renderHistory(refs: DomRefs.Refs, model: UiModel): void {
    const state = model.appState;
    if (!state) return;
  ...
  function populateOptions(refs: DomRefs.Refs, state: AppViewState): void {
