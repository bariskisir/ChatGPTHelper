...
impl PartialOrd for ConstTypeId {
    ...
    #[inline]
    // Describes the partial cmp behavior.
...
{
    trait NonStaticAny {
        // Describes the get type id behavior.
